(() => {
	...
	const confirmContent = bidConfirmModal?.querySelector(".bid-modal__content--confirm");
	const loadingContent = bidConfirmModal?.querySelector(".bid-modal__content--loading");
	const successContent = bidConfirmModal?.querySelector(".bid-modal__content--success");
	...
	document.addEventListener("keydown", (event) => {
		if (event.key === "Escape" && !bidConfirmModal.hidden && !isLockedModalState()) {
			closeModal();
		}
	});
